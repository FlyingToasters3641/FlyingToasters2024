...
public class Robot extends LoggedRobot {
  ...
  public void robotInit() {
    ...
    // the "Understanding Data Flow" page // Start logging! No more data receivers,
  ...
  public void robotPeriodic() {
    ...
    visionEst.ifPresent(
        est -> {
          ...
          m_robotContainer.m_robotDrive.addVisionMeasurement(est.estimatedPose.toPose2d(), est.timestampSeconds,
              estStdDevs);
        });
