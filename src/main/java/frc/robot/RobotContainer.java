...
public class RobotContainer {
    ...
    autoChooser.addOption("MiddleStealer", new PathPlannerAuto("TricksterDemon"));
    autoChooser.addOption("MiddleStealerLucas", new PathPlannerAuto("LucasTricksterDemon"));
