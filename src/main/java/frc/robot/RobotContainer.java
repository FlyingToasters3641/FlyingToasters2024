...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    m_driverController.rightTrigger().whileTrue(IntakeCommands.runSpeed(m_intake, () -> m_driverController.getRightTriggerAxis())).onFalse(IntakeCommands.stopIntake(m_intake));
    m_driverController.leftTrigger().whileTrue(IntakeCommands.reverseSpeed(m_intake, () -> m_driverController.getLeftTriggerAxis())).onFalse(IntakeCommands.stopIntake(m_intake));
