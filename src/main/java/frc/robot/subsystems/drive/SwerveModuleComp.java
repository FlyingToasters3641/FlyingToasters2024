  ...
  public SwerveModuleComp(int index) {
    switch (index) {
      case 0: // Front Left
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(-0.050537));//-1.00927 // MUST BE CALIBRATED
        break;
      case 1: // Front Right
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(0.073486));//-0.888184 // MUST BE CALIBRATED
        break;
      case 2: // Rear Left
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(0.007080));//-0.999512 // MUST BE CALIBRATED
        break;
      case 3: // Rear Right
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(-0.006836)); //-1.496826// MUST BE CALIBRATED
        break;
      default:
