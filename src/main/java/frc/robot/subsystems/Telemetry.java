...
public class Telemetry {
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        Logger.recordOutput("Drivetrain/RobotPose", pose);
        Logger.recordOutput("Drivetrain/X_Pos", pose.getX());
        Logger.recordOutput("Drivetrain/Y_Pos", pose.getY());
        Logger.recordOutput("Drivetrain/Angle", pose.getRotation().getDegrees());
